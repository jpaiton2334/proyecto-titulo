          ...
          <a class="nav-link" href="#">Features</a>
					...
					<li class="nav-item dropdown">
						...
						<ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
							...
							<li><a class="dropdown-item" href="../formularios/registrar_nuevo_sector.php">Asignar
									sector</a></li>
							<li><a class="dropdown-item" href="../formularios/registrar_delincuente.php">Nuevo
									delincuente</a></li>
							<li><a class="dropdown-item" href="../formularios/registro_delito.php">Nuevo delito
									delincuente</a></li>
							<li><a class="dropdown-item" href="../formularios/registrar_pariente.php">Nuevo pariente</a>
							</li>
							<li><a class="dropdown-item" href="../formularios/registrar_parentesco.php">Nuevo
									parentesco</a></li>
					...
					<li class="nav-item dropdown">
						...
						<ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
							<li><a class="dropdown-item" href="../listado_datos/listado_delincuentes.php">delincuentes
									por alfabeto</a></li>
							<li><a class="dropdown-item" href="../listado_datos/comuna_delincuente.php">delincuentes por
									comuna</a></li>
							<li><a class="dropdown-item" href="../listado_datos/ultima_ves_visto.php">delincuente ultima
									ves visto</a></li>
							<li><a class="dropdown-item" href="../listado_datos/listado_fechas_especificas.php">Listado
									por fechas especificas</a></li>
							<li><a class="dropdown-item" href="../listado_datos/listado_comunas.php">Listado comunas</a>
							</li>
		...
		<div class="row">
			<div class="col-10 col-md-6 mt-4 mb-4" id="colum1">
				<form  id="formulario"  class="form-style-9" >
					<h3 class="mt-3" id="inicio">Registrar Comuna</h3>

					<label>Nombre de la comuna</label>
				
					<input type="text" pattern="[A-Za-z ]+" name="comuna" minlength="5" maxlength="15"
						class="form-control" placeholder="ej: Santiago" required />
			...
			<div class=" col-10 col-md-12 mt-4 mb-4" id="colum3">
				<h3>registra el nombre de una nueva comuna para hacer el monitoreo de los delitos</h3>
			</div>
		</div>
	</div>
			...
			<div class="row">
				...
				<div class="col-lg-4 col-md-12 mb-4 mb-md-0">
					...
					<ul class="list-unstyled mb-0">
						...
						<li>
							<a href="../formularios/registrar_delincuente.php" class="text-white">Registro de
								delincuentes</a>
						</li>
						<li>
...
formulario.addEventListener('submit', function(e){
   ...
   fetch('../formularios_guardar/guardar_comuna.php',{
   ...
   .then(data =>{
    ...
    if(data ==='error'){
      ...
      `
       ...
       respuesta.innerHTML= `
        <div class="alert alert-danger" role="alert">
           La comuna ya se encuentra registrada							
        </div>
        `
    }
