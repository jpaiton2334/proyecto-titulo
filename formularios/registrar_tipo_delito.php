...
<h3 class="mt-3" id="inicio">Registrar tipo de delito</h3>
...
<input type="text"pattern="[A-Za-z ]+" name="delito" autocomplete="off" minlength="3" maxlength="50" class="form-control" required  placeholder="ej: Robo con violencia"/>
...
<div class="col-10 col-md-6 mt-4 mb-4" id="colum2">
			...
			<div class=" col-10 col-md-12 mt-4 mb-4" id="colum3">
				<h3>Registra el nombre de una nuevo delito para el sistema de delitos</h3>
...
formulario.addEventListener('submit', function(e){
   ...
   fetch('../formularios_guardar/guardar_tipo_delito.php',{
   ...
   .then(data =>{
    ...
    if(data ==='error'){
      ...
      `
       ...
       respuesta.innerHTML= `
        <div class="alert alert-danger" role="alert">
		Tipo de delito repetido - debe ingresar otro nombre						
        </div>
        `
    }
