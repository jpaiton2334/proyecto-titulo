...
<form  action="../formularios_guardar/guardar_parentesco.php" class="form-style-9" method="post" id="formulario">
<h3 class="mt-3" id="inicio">Registrar un parentesco</h3>
...
<div class="col-10 col-md-6 mt-4 mb-4" id="colum2">
				<img src="../img/parentesco1.jpg" alt="">

			</div>
			<div class=" col-10 col-md-12 mt-4 mb-4" id="colum3">
				<h3>registra el nombre de un parentesco para asociar a los delincuentes</h3>
			</div>
</div>
</div>
<!-- Footer -->
