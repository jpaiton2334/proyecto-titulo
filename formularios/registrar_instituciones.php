...
<h3 class="mt-3" id="inicio">Registrar Institucion</h3>
...
<label>Nombre de la institucion</label>
<input type="text"pattern="[A-Za-z ]+" name="nombre_ins" autocomplete="off" minlength="3" maxlength="50" class="form-control" required  placeholder="ej: Seguridad ciudadana"/>
...
<div class="col-10 col-md-6 mt-4 mb-4" id="colum2">
				<img src="../img/justy.png" alt="">

			</div>
			<div class=" col-10 col-md-12 mt-4 mb-4" id="colum3">
				<h3>Registra el nombre de una nueva institucion para para poder llevar el control del sistema de delitos</h3>
...
formulario.addEventListener('submit', function(e){
   ...
   fetch('../formularios_guardar/guardar_institucion.php',{
   ...
   .then(data =>{
    ...
    if(data ==='error'){
      ...
      `
       ...
       respuesta.innerHTML= `
        <div class="alert alert-danger" role="alert">
		institucion ya registrada - debe ingresar otro nombre						
        </div>
        `
    }
