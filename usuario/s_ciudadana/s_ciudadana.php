...
<img src="../../iconos/s.png " width="60" class="mb-4 mt-4" alt="">
  ...
  <li class="nav-item">
    ...
    <a class="nav-link active mb-4 mt-4 ms-5 text-white "   aria-current="page" href="s_ciudadana.php">INICIO</a>
  </li>
  ...
  <div class="container">
      ...
      <div class="col-12 col-md-4 mt-5" id="inicio">
        <div class="card" style="width: 75%; height: 100%;">
          ...
          <div class="card-body ">
            ...
            <a href="../../formularios/registro_delito.php" class="btn btn-secondary">Registrar delito</a>
          </div>
        </div>
      </div>
      ...
      <div class="col-12 col-md-4 mt-5">
        <div class="card" style="width: 75%; height: 100%;">
          ...
          <div class="card-body">
            ...
            <a href="../../zona/zona_ciudadana/registros/delincuente_cui.php" class="btn btn-secondary">Registrar delincuente</a>
          </div>
        </div>
      </div>
    ...
    <a href="../../formularios/registrar_pariente.php" class="btn btn-secondary">Registrar pariente </a>
  </div>
        </div>
      </div>
    </div>
