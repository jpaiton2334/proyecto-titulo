...
$sth = $dbh->query('SELECT nombres,tipo_delito.nombre
FROM delincuente,delito,tipo_delito
 WHERE delitos = cod_delito AND
    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
      <ul class="navbar-nav">
        ...
        <li class="nav-item ">
          ...
          <a class="nav-link" href="login.php"> <i class="fas fa-user-plus"></i> Iniciar sesion</a>
         
        </li>
        <li class="nav-item">
          <a class="nav-link" href="login.php"><i class="fas fa-user-times"></i> Cerrar sesion</a>
        </li>
      </ul>
    </div>
  </div>
     ...
     <h1 class="text-center text-light">REGISTROS</h1>
         <h2 class="text-center text-light">Listado de delincuentes por delito cometido  <span class="badge badge-warning"></span></h2> 
     </header>    
