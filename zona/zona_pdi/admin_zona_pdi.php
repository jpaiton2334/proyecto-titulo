      ...
      <div class="col-12 col-md-4 mt-5">
        <div class="card" style="width: 18rem;">
          ...
          <div class="card-body">
            ...
            <p class="card-text">Crear sectores para monitorear</p>
            <a href="../../formularios/registrar_nuevo_sector.php" class="btn btn-primary">Registrar sector</a>
          </div>
        </div>
      </div>
...
<div class="card" style="width: 18rem;">
  ...
  <div class="text-center p-3" style="background-color: #08088A;color:aliceblue;">
    ...
    <a class="" style="color:white;" href="mailto:jpabloperaltacasanova@gmail.com"> jpabloperaltacasanova@gmail.com</p></a>
  </div>
