...
<link rel="shortcut icon" href="../../iconos/s.png" type="image/x-icon">
  ...
  <title>Administrador seguridad ciudadana</title>
...
<li class="nav-item">
<img src="../../iconos/s.png " width="55" class="mb-4 mt-4" alt="" href="admin_zona_ciudadana.php">
</li>
  <li class="nav-item">
  
    <a class="nav-link active mb-4 mt-4 ms-5 text-white "   aria-current="page" href="admin_zona_ciudadana.php">INICIO</a>
  </li>
...
<div class="card" style="width: 75%; height: 100%;">
  ...
  <div class="card-body">
    ...
    <a href="../../listado_datos/listado_delincuentes.php" class="btn btn-secondary">Ver delincuentes </a>
  </div>
</div>
</div>
...
<div class="card" style="width: 75%; height: 100%;">
  ...
  <div class="card-body">
    ...
    <a href="../../listado_datos/comuna_delincuente.php" class="btn btn-secondary">Ver delincuentes </a>
  </div>
</div>
</div>
...
<div class="card" style="width: 75%; height: 100%;">
  ...
  <div class="card-body">
    ...
    <a href="../../listado_datos/listado_fechas_especificas.php" class="btn btn-secondary">ver delitos </a>
  </div>
</div>
</div>
</div>
...
<div class="card" style="width: 75%; height: 100%;">
  ...
  <div class="card-body">
    ...
    <a href="../../listado_datos/ultima_ves_visto.php" class="btn btn-secondary">Ver delincuentes </a>
  </div>
</div>
</div>
...
<div class="card" style="width: 75%; height: 100%;">
  ...
  <div class="card-body">
    ...
    <a href="../../listado_datos/listado_parientes.php" class="btn btn-secondary">Ver delincuentes </a>
  </div>
</div>
</div>
