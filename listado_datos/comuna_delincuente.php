  ...
  <body> 
	...
	<!-- fin barra de navegacion -->
     ...
     <h1 class="text-center ">REGISTROS</h1>
         <h2 class="text-center ">Listado  de delincuentes por comuna  <span class="badge badge-warning"></span></h2> 
     </header>    
    ...
    <div class="container">
        <div class="row">
                <div class="col-lg-12">
                    <div class="table-responsive" id="inicio"> 
                        
                 
                        <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%" id="tabla">
                        <thead>
                            <tr>
                                <th>Comuna</th>
                               <th>Nombres</th>
