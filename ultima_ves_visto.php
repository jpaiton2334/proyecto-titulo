...
$sth = $dbh->query('SELECT nombres,nombre_comuna,fecha
FROM delincuente,ultimo_lugar_visto_delincuente
 WHERE ultimo_lugar_visto = ultimo_lugar_visto_delincuente.id;
');
