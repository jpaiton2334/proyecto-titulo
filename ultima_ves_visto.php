...
$sth = $pdo->query('SELECT delincuente.nombres, nuevo_delito_delincuente.descripcion, nuevo_delito_delincuente.fecha_delito,tipo_delito.nombre
from delincuente, nuevo_delito_delincuente,tipo_delito
where delincuente.id = nuevo_delito_delincuente.id_delincuente AND
tipo_delito.id = nuevo_delito_delincuente.típo_delito;');
