...
<form method="post" action="guardar_comuna.php" id="formulario">
...
<input type="text"pattern="[A-Za-z-0-9 ]+" name="comuna" autocomplete="off" minlength="5" maxlength="50" class="form-control" required  placeholder="ej: Santiago"/>
